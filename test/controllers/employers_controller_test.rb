...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference("Employer.count") do
      post employers_url, params: { employer: { company_name: @employer.company_name, contact: @employer.contact, email: @employer.email, name: @employer.name, social_url: @employer.social_url } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { company_name: @employer.company_name, contact: @employer.contact, email: @employer.email, name: @employer.name, social_url: @employer.social_url } }
